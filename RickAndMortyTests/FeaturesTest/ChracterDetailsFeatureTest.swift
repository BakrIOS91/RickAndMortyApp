...
//    
//    @Test("Given a character details feature, When initialized with character ID, Then state is set correctly")
...
//        
//        // Then
//        XCTAssertEqual(store.state.characterId, characterId)
//        XCTAssertEqual(store.state.viewState, .loaded)
//        XCTAssertNil(store.state.characterDetails)
//    }
//    
//    @Test("Given a character details feature, When character details are loaded, Then character data is available")
//    func testCharacterDetailsLoaded() async {
//        let characterId = 781
//        let mockCharacter = CharacterListItem.mockCharacterListItem
//        let store = await TestStore(
//            initialState: ChracterDetailsFeature.State(
...
//        // Then
//        XCTAssertEqual(store.state.characterId, characterId)
//        XCTAssertEqual(store.state.characterDetails, mockCharacter)
//        XCTAssertEqual(store.state.viewState, .loaded)
//    }
//    
//    // MARK: - Error Handling
...
//            $0.charactersClient = CharactersClient(
//                getCharacters: { _, _ in .success(.mockCharacterList) },
//                getChracterDetails: { _ in .failure(.serverError) }
//            )
//        }
//        
//        // When
...
//            $0.charactersClient = CharactersClient(
//                getCharacters: { _, _ in .success(.mockCharacterList) },
//                getChracterDetails: { _ in .failure(.unExpectedError) }
//            )
//        }
//        
//        // When
